...
const PaginationNumber = (props:{pageNumber: number}) => {
  ...
  return ( 
      ...
      :
      <button
        className={page !== props.pageNumber ? 'font-Poppins font-semibold text-sm text-button-text py-2 px-4 border border-solid rounded-lg border-page-button border-2':'font-Poppins font-semibold text-sm text-selected-button-text py-2 px-4 border border-solid rounded-lg border-page-button-focus border-2 bg-focus-button-bg'}
